...
#[proto_message(type_url = "/osmosis.cosmwasmpool.v1beta1.PoolRawFilteredStateRequest")]
#[proto_query(
    path = "/osmosis.cosmwasmpool.v1beta1.Query/PoolRawFilteredState",
    response_type = PoolRawFilteredStateResponse
)]
...
#[proto_message(type_url = "/osmosis.cosmwasmpool.v1beta1.PoolRawFilteredStateResponse")]
...
impl<'a, Q: cosmwasm_std::CustomQuery> CosmwasmpoolQuerier<'a, Q> {
    ...
    pub fn pool_raw_filtered_state(
        &self,
        pool_id: u64,
        key_filter: ::prost::alloc::string::String,
        value_filter: ::prost::alloc::string::String,
    ) -> Result<PoolRawFilteredStateResponse, cosmwasm_std::StdError> {
